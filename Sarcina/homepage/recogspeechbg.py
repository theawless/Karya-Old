...
class SpeechRecogniser:
    ...
    def start_recognising(self):
        ...
        logger.debug("Inside \"start_recognising\" function")
        while True:
    ...
    def recog_callback(self, r, audio):
        ...
        logger.debug("Inside \"recog_callback\"")
        sel = "Sphinx"
        recognized_text = "######"
        # Recogniser begins
        if sel == "Sphinx":
        ...
        #         GLib.idle_add(self.search_entry_text_set, "Got your words! Processing with Google Speech Recognition")
        ...
        #         except sr.UnknownValueError:
        #             GLib.idle_add(self.search_entry_text_set, "Google Speech Recognition could not understand audio")
        #         except sr.RequestError as e:
        #             GLib.idle_add(self.search_entry_text_set,
        ...
        #     GLib.idle_add(self.search_entry_text_set, "Got your words! Processing with WIT.AI")
        ...
        #     except sr.UnknownValueError:
        #         GLib.idle_add(self.search_entry_text_set, "Wit.ai could not understand audio")
        #     except sr.RequestError as e:
        #         GLib.idle_add(self.search_entry_text_set, "Could not request results from Wit.ai service; {0}".format(e))
        #     finally:
        #         GLib.idle_add(self.plugin_action_handler, recognized_text)
        #
        # elif sel == "Bing":
        #     # recognize speech using Microsoft Bing Voice Recognition
        #     GLib.idle_add(self.search_entry_text_set, "Got your words! Processing with Bing")
        ...
        #     except sr.UnknownValueError:
        #         GLib.idle_add(self.search_entry_text_set, "Microsoft Bing Voice Recognition could not understand audio")
        #     except sr.RequestError as e:
        #         GLib.idle_add(self.search_entry_text_set,
        ...
        #     GLib.idle_add(self.search_entry_text_set, "Got your words! Processing with API.AI")
        ...
        #     except sr.UnknownValueError:
        #         GLib.idle_add(self.search_entry_text_set, "api.ai could not understand audio")
        #     except sr.RequestError as e:
        #         GLib.idle_add(self.search_entry_text_set, "Could not request results from api.ai service; {0}".format(e))
        #     finally:
        #         GLib.idle_add(self.plugin_action_handler, recognized_text)
        #
        # elif sel == "IBM":
        #     # recognize speech using IBM Speech to Text
        #     GLib.idle_add(self.search_entry_text_set, "Got your words! Processing with IBM")
        ...
        #     except sr.UnknownValueError:
        #         GLib.idle_add(self.search_entry_text_set, "IBM Speech to Text could not understand audio")
        #     except sr.RequestError as e:
        #         GLib.idle_add(self.search_entry_text_set,
