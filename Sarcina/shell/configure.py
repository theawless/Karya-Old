...
SHELL_PAGE_PATH = os.path.dirname(os.path.abspath(__file__))
CONFIG_FILE_PATH = SHELL_PAGE_PATH + "/config.ini"
CONFIG_DIALOG_UI_PATH = SHELL_PAGE_PATH + "/configureui.glade"
