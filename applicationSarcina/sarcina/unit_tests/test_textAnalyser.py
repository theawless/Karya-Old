...
# print(result2)
dict1 = {'repeat': 5,
         'time_of_execution': {'day': datetime.now().day + int((int(datetime.now().hour) + 20) / 24),
                               'hour': (int(datetime.now().hour) + 20) % 24, 'minute': datetime.now().minute},
...
dict4 = {'repeat': 1,
         ...
         'action': {'start_dictation': '',
                    ...
                    'calculate': {'op2': '', 'op1': '', 'operand': ''}}}
dict5 = {'repeat': '',
         'time_of_execution': {'day': datetime.now().day + int((int(datetime.now().hour) + 15) / 24),
                               'hour': (int(datetime.now().hour) + 15) % 24, 'minute': datetime.now().minute},
         'action': {'start_dictation': '',
                    'run_application': 'gedit',
                    'search': '',
                    'play': '',
...
dict6 = {'repeat': '',
         ...
         'action': {'start_dictation': '',
                    ...
                    'calculate': {'op2': '', 'op1': '', 'operand': ''}}}
dict7 = {'repeat': '',
         'time_of_execution': {'day': datetime.now().day + int((int(datetime.now().hour) + 48) / 24),
                               'hour': (int(datetime.now().hour) + 48) % 24, 'minute': datetime.now().minute},
         'action': {'start_dictation': '',
                    'run_application': '',
                    'search': '',
                    'play': '',
...
dict8 = {'repeat': '',
         'time_of_execution': {
             'day': datetime.now().day + int((datetime.now().hour + int((datetime.now().minute + 20) / 60)) / 24),
             'hour': int(datetime.now().hour + int((datetime.now().minute + 20) / 60)) % 24,
             'minute': (int(datetime.now().minute) + 20) % 60},
